...
const TestimonialCard = ({ rating, comment, clientName, clientRole, clientImage }) => {
  return ( <div className="bg-white shadow-soft w-100 p-6 rounded-lg flex flex-col items-center justify-between text-center gap-4 md:w-140 mx-auto md:p-5  lg:gap-5">
